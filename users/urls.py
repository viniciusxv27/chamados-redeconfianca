...
urlpatterns = [
    ...
    path('manage/sessions/terminate/', views.terminate_session_view, name='terminate_session'),
    ...
    path('manage/checklists/template/<int:template_id>/edit/', views.edit_checklist_template, name='edit_checklist_template'),
