...
SYSTEM = (
    ...
    "metas e feedbacks do Impulso, trilhas de conhecimento, elogios, Confianças (C$), "
    "notificações e pastas do Drive dele. Para uma visão geral do que ele tem em aberto, "
    "use a ferramenta resumo_geral. Se (e somente se) o usuário for SUPERADMIN, "
