...
FACTOR_RANGE_SPECS = {
    ROLE_CONSULTOR: [
        FactorRangeSpec('essenciais_commission', 'Essenciais - Comissão', 'B6:E8'),
        FactorRangeSpec('essenciais_premium_individual', 'Essenciais - Premiação Individual', 'B9:E10'),
        FactorRangeSpec('essenciais_premium_pdv', 'Essenciais - Premiação PDV', 'B11:E11'),
        FactorRangeSpec('movel_commission', 'Móvel - Comissão', 'I4:K6'),
        FactorRangeSpec('movel_premium_individual', 'Móvel - Premiação Individual', 'I7:K8'),
        FactorRangeSpec('movel_premium_pdv', 'Móvel - Premiação PDV', 'I9:K9'),
        FactorRangeSpec('fixa_commission', 'Fixa - Comissão', 'I12:K14'),
        FactorRangeSpec('fixa_premium_individual', 'Fixa - Premiação Individual', 'I15:K16'),
        FactorRangeSpec('fixa_premium_pdv', 'Fixa - Premiação PDV', 'I17:K17'),
        FactorRangeSpec('eletronicos_commission', 'Eletrônicos - Comissão', 'B16:E18'),
        FactorRangeSpec('eletronicos_premium_individual', 'Eletrônicos - Premiação Individual', 'B19:E20'),
        FactorRangeSpec('eletronicos_premium_pdv', 'Eletrônicos - Premiação PDV', 'B21:E21'),
        FactorRangeSpec('smartphones_commission', 'Smartphones - Comissão', 'B25:D26'),
        FactorRangeSpec('smartphones_premium_individual', 'Smartphones - Premiação Individual', 'B27:D27'),
        FactorRangeSpec('smartphones_premium_pdv', 'Smartphones - Premiação PDV', 'B28:D28'),
        FactorRangeSpec('seguros_commission', 'Seguros - Comissão', 'O4:Q6'),
        FactorRangeSpec('seguros_premium_individual', 'Seguros - Premiação Individual', 'O7:Q8'),
        FactorRangeSpec('seguros_premium_pdv', 'Seguros - Premiação PDV', 'O9:Q9'),
        FactorRangeSpec('sva_commission', 'SVA - Comissão', 'Q12:Q12'),
        FactorRangeSpec('sva_premium_individual', 'SVA - Premiação Individual', 'O15:Q16'),
        FactorRangeSpec('sva_premium_pdv', 'SVA - Premiação PDV', 'O17:Q17'),
    ],
    ROLE_GERENTE: [
        FactorRangeSpec('essenciais_commission', 'Essenciais - Comissão', 'B34:E36'),
        FactorRangeSpec('essenciais_premium_individual', 'Essenciais - Premiação Individual', 'B37:E38'),
        FactorRangeSpec('essenciais_premium_pdv', 'Essenciais - Premiação PDV', 'B39:E39'),
        FactorRangeSpec('movel_commission', 'Móvel - Comissão', 'I32:K34'),
        FactorRangeSpec('movel_premium_individual', 'Móvel - Premiação Individual', 'I35:K36'),
        FactorRangeSpec('movel_premium_pdv', 'Móvel - Premiação PDV', 'I37:K37'),
        FactorRangeSpec('fixa_commission', 'Fixa - Comissão', 'I40:K42'),
        FactorRangeSpec('fixa_premium_individual', 'Fixa - Premiação Individual', 'I43:K44'),
        FactorRangeSpec('fixa_premium_pdv', 'Fixa - Premiação PDV', 'I45:K45'),
        FactorRangeSpec('eletronicos_commission', 'Eletrônicos - Comissão', 'B44:E46'),
        FactorRangeSpec('eletronicos_premium_individual', 'Eletrônicos - Premiação Individual', 'B47:E48'),
        FactorRangeSpec('eletronicos_premium_pdv', 'Eletrônicos - Premiação PDV', 'B49:E49'),
        FactorRangeSpec('smartphones_commission', 'Smartphones - Comissão', 'B53:D54'),
        FactorRangeSpec('smartphones_premium_individual', 'Smartphones - Premiação Individual', 'B55:D55'),
        FactorRangeSpec('smartphones_premium_pdv', 'Smartphones - Premiação PDV', 'B56:D56'),
        FactorRangeSpec('seguros_commission', 'Seguros - Comissão', 'O32:Q34'),
        FactorRangeSpec('seguros_premium_individual', 'Seguros - Premiação Individual', 'O35:Q36'),
        FactorRangeSpec('seguros_premium_pdv', 'Seguros - Premiação PDV', 'O37:Q37'),
        FactorRangeSpec('sva_commission', 'SVA - Comissão', 'Q40:Q40'),
        FactorRangeSpec('sva_premium_individual', 'SVA - Premiação Individual', 'O43:Q44'),
        FactorRangeSpec('sva_premium_pdv', 'SVA - Premiação PDV', 'O45:Q45'),
    ],
    ROLE_COORDENADOR: [
        FactorRangeSpec('essenciais_commission', 'Essenciais - Comissão', 'B63:E67'),
        FactorRangeSpec('movel_commission', 'Móvel - Comissão', 'I61:K65'),
        FactorRangeSpec('fixa_commission', 'Fixa - Comissão', 'I68:K72'),
        FactorRangeSpec('eletronicos_commission', 'Eletrônicos - Comissão', 'B72:E76'),
        FactorRangeSpec('smartphones_commission', 'Smartphones - Comissão', 'B80:D83'),
        FactorRangeSpec('seguros_commission', 'Seguros - Comissão', 'O61:Q65'),
        FactorRangeSpec('sva_commission', 'SVA - Comissão', 'Q68:Q68'),
    ],
}
