...
urlpatterns = [
    ...
    path('project/<int:project_id>/set-completion-date/', views.set_completion_date, name='set_completion_date'),
    ...
    path('support/chat/<int:chat_id>/poll/', views_chat.poll_chat_updates, name='poll_chat_updates'),
    path('support/chat/<int:chat_id>/queue-position/', views_chat.get_user_queue_position, name='get_user_queue_position'),
    path('support/chat/<int:chat_id>/upload/', views_chat.upload_chat_file_with_message, name='upload_chat_file_with_message'),
    path('support/queue-status/', views_chat.get_queue_status, name='get_queue_status'),
    ...
    path('support/chat/<int:chat_id>/transfer/', views_chat.transfer_support_chat, name='transfer_support_chat'),
    path('support/chat/<int:chat_id>/change-category/', views_chat.change_chat_category, name='change_chat_category'),
    path('support/chat/<int:chat_id>/update-status/', views_chat.update_chat_status, name='update_chat_status'),
    path('support/metrics/', views_chat.support_metrics_page, name='support_metrics'),
    path('support/metrics/api/', views_chat.support_metrics_api, name='support_metrics_api'),
