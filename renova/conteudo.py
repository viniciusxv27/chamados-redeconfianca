...
PASSO_A_PASSO = [
    {'titulo': 'Remover capa, película e acessórios', 'icone': 'fa-solid fa-layer-group', 'itens': [
        'Retire capa, película, filmes e acessórios para avaliar o aparelho corretamente.',
    ]},
    {'titulo': 'Verificar e remover o iCloud do cliente', 'icone': 'fa-brands fa-apple', 'numerado': True, 'itens': [
    ...
    {'titulo': 'Verificar se teve peça trocada', 'icone': 'fa-solid fa-screwdriver-wrench', 'itens': [
    ...
    {'titulo': 'Verificar a saúde da bateria', 'icone': 'fa-solid fa-battery-three-quarters', 'itens': [
    ...
    {'titulo': 'Testar o Face ID', 'icone': 'fa-solid fa-face-smile', 'itens': [
    ...
    {'titulo': 'Testar as câmeras', 'icone': 'fa-solid fa-camera', 'itens': [
    ...
    {'titulo': 'Testar a tela', 'icone': 'fa-solid fa-mobile-screen-button', 'itens': [
    ...
    {'titulo': 'Testar áudio, microfone e alto-falantes', 'icone': 'fa-solid fa-volume-high', 'itens': [
    ...
    {'titulo': 'Testar rede celular, Wi-Fi e Bluetooth', 'icone': 'fa-solid fa-signal', 'itens': [
    ...
    {'titulo': 'Testar o carregamento', 'icone': 'fa-solid fa-charging-station', 'itens': [
    ...
    {'titulo': 'Avaliar o estado estético', 'icone': 'fa-solid fa-magnifying-glass', 'itens': [
    ...
    {'titulo': 'Restaurar o aparelho (após aprovação)', 'icone': 'fa-solid fa-rotate', 'itens': [
